...
Library is available from https://github.com/MotorDriver/L6474 and is released under the GNU General Public License version 2 or the GNU Lesser General Public License version 2.1 
